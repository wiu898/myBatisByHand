...
import com.xc.mybatis.v2.TestMybatis;
import com.xc.mybatis.v2.annotation.Entity;
import com.xc.mybatis.v2.annotation.Select;
import com.xc.mybatis.v2.binding.MapperRegistry;
import com.xc.mybatis.v2.executor.CachingExecutor;
import com.xc.mybatis.v2.executor.Executor;
import com.xc.mybatis.v2.executor.SimpleExecutor;
import com.xc.mybatis.v2.interceptor.Interceptor;
import com.xc.mybatis.v2.interceptor.InterceptorChain;
...
public class Configuration {
    ...
    public Configuration(){
        //Note:在Properties和注解中重复配置的SQL会覆盖
        //1.解析sql.properties
        ...
        String[] pluginPaths = pluginPathValue.split(",");    //可能会配置多个插件
        if(pluginPaths != null){
            //将所有插件添加到interceptorChain中
